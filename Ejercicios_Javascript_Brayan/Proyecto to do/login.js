...
function realizarRegister(settings){// settings es el objeto que se le esta pasando al fetch
    ...
    fetch(`${url}/user/login`,settings)//aca se usa un temple strings para concatenar la url con el enpoint /user "url+"/users"" esta es otra forma
